...
void init(){
	...
	program[0] = InitShader( "vshader56.glsl", "fshader56.glsl" );//( "vshaderUnifColor.glsl", "fshaderStock.glsl" );
	program[1] = InitShader( "skyboxvertex.glsl", "skyboxfragment.glsl" );
...
void display( void )
{
	...
	glUniform4fv( glGetUniformLocation(program[0], "LightPosition"), 1, light_position );
